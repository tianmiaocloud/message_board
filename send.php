...
<div class='container'>
    ...
    <div class='block'><a href='index.php?act=index'>首页</a> | <a href='index.php?act=write'>我要留言</a> | <a href='index.php?act=view'>查看留言</a> | <a href='index.php?act=login'>管理留言</a></div>
                        ...
                        <form name='form1' action='send.php？act=add' method='POST' id='form1' onsubmit='return check();'>
                            <div class='ly_list'>
                                <ul>
                                    ...
                                    <li><div class='left'>Email：</div><div class='right'><input name='email' type='text' class='text' /></div></li>
